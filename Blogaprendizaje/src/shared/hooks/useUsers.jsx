...
import { getUsers as getUsersRequest, getProducts, saveUsers as saveUsersRequest, updateUser as updateUserRequest, deleteUser as deleteUserRequest } from "../../services";
...
export const useUser = () => {
    ...
    const updateUser = async (id, updateUser) => {
        const result = await updateUserRequest(id, updateUser);
